  ...
  render() {
    return(
      <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', backgroundImage: 'url("https://www.thehappycatsite.com/wp-content/uploads/2017/11/kitten-tabby.jpg")', minHeight: '90vh', backgroundSize: 'cover', backgroundPosition: 'center'}}>
        <button style={{padding: '1.5rem', backgroundColor: 'black', color: '#fff', fontSize: '18px', top: 'calc(100vh - 200px)', border: '0', position: 'fixed', borderRadius: '50px', textTransform: 'uppercase'}} onClick={this.handelClick}>tell me something nice</button>
